...
for name, marks in report_card.items():
    print(f"{name}: {marks}")

# Q9. Get "Deepak"'s marks safely — if not found, return 0.
#     Use .get() with a default value.
print(report_card.get("Deepak", 0))
